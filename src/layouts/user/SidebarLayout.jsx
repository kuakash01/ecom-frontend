...
function SidebarLayout() {
  ...
  return (
      ...
      <div className="h-screen flex flex-col bg-white dark:bg-brand-dark-500 border-r-1 text-black dark:text-white border-brand-500 dark:border-brand-500 relative z-50 ">
        {isMobileOpen && (
